...
typedef ezbakeBaseTypes.TokenType TokenType
...
/*
 *  Exceptions that are specific to the EzGroups service
 */
 ...
 */
service EzGroups extends ezbakeBaseService.EzBakeBaseService {
    /* ---------------------------------------------------------------------------------- */
    /* ---------------------------------------------------------------------------------- */
    /*                                 Group Operations                                   */
    /* ---------------------------------------------------------------------------------- */
    ...
    void changeGroupInheritance(
        ...
        3:required GroupInheritancePermissions inheritance
    ) throws (
        1:ezbakeBaseTypes.EzSecurityTokenException tokenError,
        2:AuthorizationException authorizationError,
        3:EzGroupOperationException createError
   ...
   void addUserToGroup(
        ...
        4:required UserGroupPermissions permissions
   ) throws (
        1:ezbakeBaseTypes.EzSecurityTokenException tokenError,
        2:AuthorizationException authorizationError,
        3:EzGroupOperationException createError
    ...
    */
    ...
    set<i64> getUserAuthorizations(
        ...
        3:required string userID,
        4:required list<string> appChain
    ) throws (
        1:ezbakeBaseTypes.EzSecurityTokenException tokenError,
        2:AuthorizationException authorizationError,
        3:GroupQueryException createError
